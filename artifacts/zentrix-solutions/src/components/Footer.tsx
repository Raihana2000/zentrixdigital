        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          ...
          <div className="md:col-span-5 flex flex-col gap-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-xs font-semibold text-white hover:text-blue-300 transition-colors duration-200 group w-fit"
              aria-label="LinkedIn"
            >
              ...
              <span className="group-hover:underline underline-offset-4 decoration-blue-300/60">
