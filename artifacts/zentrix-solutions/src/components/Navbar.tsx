...
const ROUTE_MAP_NL_TO_EN: Record<string, string> = {
  ...
  '/website-voor-zzp': '/en/website-for-freelancers',
  ...
  '/webdesign-bedrijf': '/en/web-design-company',
  '/website-laten-maken-amsterdam': '/en/website-development-amsterdam',
  '/website-kosten': '/en/website-development-costs',
  '/kosten-website-laten-maken': '/en/website-development-costs',
...
const ROUTE_MAP_EN_TO_NL: Record<string, string> = {
  ...
  '/en/web-design-company': '/webdesign-bedrijf',
  '/en/website-development-amsterdam': '/website-laten-maken-amsterdam',
  '/en/website-development-costs': '/kosten-website-laten-maken',
      ...
      >
        <div className="site-header-inner max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 gap-4">
          ...
          <div className="hidden md:flex items-center gap-3 shrink-0">
            <button
              onClick={toggleLang}
              aria-label={language === 'nl' ? 'Schakel naar Engels' : 'Switch to Dutch'}
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-full text-xs font-bold uppercase tracking-widest border border-blue-500/20 bg-blue-950/30 hover:bg-blue-950/50 hover:border-blue-500/40 transition-all duration-200 min-h-[38px]"
              data-testid="btn-toggle-lang"
            >
              <Globe className="w-3.5 h-3.5 text-blue-400/70 shrink-0" />
              <span className={language === 'nl' ? 'text-blue-400' : 'text-white/35'}>NL</span>
              <span className="text-white/20">·</span>
              <span className={language === 'en' ? 'text-blue-400' : 'text-white/35'}>EN</span>
            </button>
            <Link href="/contact">
              <button
                data-testid="btn-nav-cta"
                className="px-5 py-2.5 text-sm font-semibold rounded-full bg-blue-600/90 hover:bg-blue-500 text-white transition-all duration-200 shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] hover:scale-[1.03] min-h-[44px]"
              >
                {t.home.ctaButton}
              </button>
            </Link>
          ...
          <div className="md:hidden flex items-center gap-2 shrink-0">
            <button
              onClick={toggleLang}
              aria-label={language === 'nl' ? 'Schakel naar Engels' : 'Switch to Dutch'}
              className="flex items-center gap-1 px-3 py-2 rounded-full text-xs font-bold uppercase tracking-widest border border-blue-500/25 bg-blue-950/30 hover:bg-blue-950/50 transition-all duration-200 min-h-[40px]"
