export const en = {
  ...
  home: {
    ...
    problems: [
      { title: "Unclear message", text: "If visitors can't understand what you do within three seconds, they're gone — straight to your competitor." },
      { title: "No clear next step", text: "Without a strong call-to-action, visitors don't reach out — even if they're interested." },
      { title: "Poor mobile experience", text: "Over 60% of your visitors come via smartphone. A poor mobile experience costs you trust immediately." },
    ...
    services: {
      ...
      maintenance: {
        ...
        desc: "Ongoing maintenance for speed, security, and stable performance — so you can focus on running your business."
      },
      growth: {
    ...
    whoWeHelp: [
      { title: "Local businesses", text: "Salons, garages, shops, and service providers that want to attract more customers from their region." },
      { title: "Service providers", text: "Coaches, consultants, agents, and firms that need to build trust online to win new clients." },
    ...
    casesIntro: "We believe in transparency. We work with businesses that want real results, and we'd rather show our approach than talk about it.",
    casesBody: "Concrete examples of websites, applications, and improvement projects are available on request. Judge for yourself whether our approach fits your situation — no sales pitch.",
    ...
    trustBlockItems: [
      ...
      "Expandable to CRM, dashboard or client portal"
    ],
  ...
  servicePages: {
    websites: {
      ...
      included: [
        "Custom design based on your brand, target audience, and desired look",
      ...
      whoFor: [
        { title: "Starting entrepreneurs", text: "Who want to get online quickly and professionally — without technical hassle." },
        { title: "Local businesses", text: "That want to attract more customers through a strong online presence that works 24/7." },
        { title: "Service providers", text: "Who need to build trust online to win new clients — before the first conversation." },
        { title: "Businesses ready for a refresh", text: "With an outdated website that's costing customers rather than attracting them." }
      ],
      processTitle: "How we work",
      process: [
    ...
    applicaties: {
      ...
      includedTitle: "What's included as standard",
      included: [
        "Analysis of your current workflows and specific requirements",
        "Custom development aligned with your situation and goals",
      ...
      whoForTitle: "Who is this for",
      whoFor: [
        { title: "Businesses with specific processes", text: "That need a tool that standard software simply doesn't offer." },
        { title: "Teams looking to automate", text: "That want to replace manual tasks with smart digital processes." },
        { title: "Businesses with client portals", text: "That want to offer customers their own secure digital environment." },
        { title: "Organisations ready to scale", text: "That need a robust, reliable digital infrastructure to support growth." }
      ],
      processTitle: "How we work",
      process: [
    ...
    onderhoud: {
      ...
      included: [
        "Regular updates to CMS, plugins, and technical frameworks",
        "Continuous speed and performance monitoring",
        "Security scans and immediate patches for any risks",
        "Small adjustments and content changes on request",
        "Technical troubleshooting and fast resolution",
        "Periodic check-ins and clear reporting"
      ],
      whoForTitle: "Who is this for",
      whoFor: [
        { title: "Businesses with an existing website", text: "That don't have the time or knowledge to handle technical maintenance themselves." },
        { title: "Entrepreneurs who want peace of mind", text: "And rely on a trusted partner to watch over their digital environment." },
        { title: "Businesses generating online revenue", text: "Where downtime, slowness, or an outage directly costs money." },
        { title: "Organisations with regular updates", text: "That need changes made quickly without managing everything themselves." }
      ],
    ...
    groei: {
      ...
      whoForTitle: "Who is this for",
      whoFor: [
        { title: "Businesses with an outdated online presence", text: "That know there's more to gain from their digital channels." },
        { title: "Entrepreneurs ready to scale", text: "Who want to prepare their digital foundation for the next growth phase." },
        { title: "Businesses falling behind competitors", text: "That want to present themselves more strongly and professionally online." },
        { title: "Growing organisations", text: "Looking for structure and direction in their digital strategy and approach." }
      ],
      processTitle: "Our approach",
      process: [
