...
const solutionsData = {
  ...
  en: [
    { href: '/en/website-for-freelancers', label: 'Website for Freelancers', desc: 'Professional online presence for independent professionals' },
    { href: '/en/website-for-businesses', label: 'Website for Businesses', desc: 'Converting business website that attracts clients' },
    { href: '/en/crm-system-development', label: 'CRM System', desc: 'Custom client management for more revenue and structure' },
    { href: '/en/booking-system-development', label: 'Booking System', desc: 'Automate appointment scheduling and management' },
    { href: '/en/business-automation', label: 'Business Automation', desc: 'Automate workflows and save valuable time' },
  ],
};

const HomeSolutions = ({ language }: { language: 'nl' | 'en' }) => {
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
          <motion.div variants={fadeUp} className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-black tracking-[-0.02em] text-white leading-tight">
              {isNL ? 'Op maat gemaakte oplossingen' : 'Tailored solutions for growth'}
            </h2>
            <p className="mt-4 text-white text-base max-w-xl mx-auto leading-relaxed">
              {isNL
                ...
                : 'From websites to systems — we build what your business needs to grow.'}
            </p>
          </motion.div>
